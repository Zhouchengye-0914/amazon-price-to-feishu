...
echo   1. 首次部署 / 更新依赖
echo   2. 部署验收
echo   3. PD03 单条只读实时验证（不写飞书）
echo   4. 全量实时运行
echo   5. 注册工作日 07:30 / 15:30 计划任务
echo   6. 删除计划任务
echo   7. 打开操作手册
echo   0. 退出
echo ================================================
...
if "%choice%"=="3" call bin\run.bat --weekly-run --sheets PD03 --limit 1 --dry-run --force-fetch
if "%choice%"=="4" call bin\run.bat --weekly-run --confirm --force-fetch
